  ...
  return (
    <View style={{ marginTop: 16, paddingHorizontal: 16 }}>
      ...
      <TextInput
        ...
        placeholder="Hvað fannst þér um mynina?"
      ...
      <Button
        style={[globalStyles.defaultButton, { alignSelf: 'flex-start' }]}
        onPress={handleSubmitReview}
      >
        <Text style={globalStyles.defaultTextColor}>Staðfesta umsögn</Text>
      </Button>
        ...
        {reviews.length === 0 ? (
          ...
          reviews.map((r) => (
            ...
            >
              ...
              <Text style={globalStyles.defaultTextColor}>{r.text}</Text>
            </View>
          ))
        )}
      </View>
